...
class Bill_App:
    ...
    # =============customer retail details======================
        ...
        cname_txt.grid(row=0, column=1, pady=4, padx=8)
        ...
        cphn_txt.grid(row=0, column=3, pady=4, padx=8)
    ...
    # ===========ColdDrinks================================
        ...
        F4.place(x=670, y=180, width=300, height=370)
        ...
        sprite_txt = Entry(F4, width=9, textvariable=self.sprite, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        ...
        limka_txt = Entry(F4, width=9, textvariable=self.limka, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        ...
        wheat_txt = Entry(F4, width=9, textvariable=self.mazza, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        wheat_txt.grid(row=2, column=1, padx=10, pady=10)
        ...
        coke_txt = Entry(F4, width=9, textvariable=self.coke, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        ...
        fanta_txt = Entry(F4, width=9, textvariable=self.fanta, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        ...
        mountain_duo_txt = Entry(F4, width=9, textvariable=self.mountain_duo, font=('times new roman', 16, 'bold'), bd=5, relief=GROOVE)
        mountain_duo_txt.grid(row=5, column=1, padx=10, pady=10)

    # =================BillArea======================
        F5 = Frame(self.root, bd=10, relief=GROOVE)
        F5.place(x=970, y=180, width=300, height=300)
    ...
    # =======================ButtonFrame=============
        ...
        F6.place(x=0, y=490, relwidth=1, height=140)
        ...
        m1_txt = Entry(F6, width=15, textvariable=self.medical_price, font='arial 10 bold', bd=7, relief=GROOVE)
        ...
        m2_txt = Entry(F6, width=15, textvariable=self.grocery_price, font='arial 10 bold', bd=7, relief=GROOVE)
        ...
        m3_txt = Entry(F6, width=15, textvariable=self.cold_drinks_price, font='arial 10 bold', bd=7, relief=GROOVE)
        ...
        m4_txt = Entry(F6, width=15, textvariable=self.medical_tax, font='arial 10 bold', bd=7, relief=GROOVE)
        ...
        m5_txt = Entry(F6, width=15, textvariable=self.grocery_tax, font='arial 10 bold', bd=7, relief=GROOVE)
        ...
        m6_txt = Entry(F6, width=15, textvariable=self.cold_drinks_tax, font='arial 10 bold', bd=7, relief=GROOVE)
        m6_txt.grid(row=2, column=3, padx=18, pady=1)

    # =======Buttons-======================================
        btn_f = Frame(F6, bd=7, relief=GROOVE)
        btn_f.place(x=720, width=570, height=105)

        total_btn = Button(btn_f, command=self.total, text="Total", bg="#535C68", bd=2, fg="white", pady=15, width=10, font='arial 13 bold')
        total_btn.grid(row=0, column=0, padx=5, pady=5)

        generateBill_btn = Button(btn_f, command=self.bill_area, text="Generate Bill", bd=2, bg="#535C68", fg="white", pady=12, width=10, font='arial 13 bold')
        generateBill_btn.grid(row=0, column=1, padx=5, pady=5)

        clear_btn = Button(btn_f, command=self.clear_data, text="Clear", bg="#535C68", bd=2, fg="white", pady=15, width=10, font='arial 13 bold')
        clear_btn.grid(row=0, column=2, padx=5, pady=5)

        exit_btn = Button(btn_f, command=self.exit_app, text="Exit", bd=2, bg="#535C68", fg="white", pady=15, width=10, font='arial 13 bold')
...
#==============welcome-bill==============================
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\tWelcome Online retail")
